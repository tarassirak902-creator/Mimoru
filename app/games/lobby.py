...
_TIMED_LOBBY_GAMES = {"mafia", "spy", "quiz", "battleship", "roulette", "crocodile", "cards"}
...
async def lobby_text(
    ...
    *,
    ...
    lines.extend([
        ...
        if game.game_type in _TIMED_LOBBY_GAMES
        else "",
    ...
    *,
    ...
    record = await session.scalar(
        select(GameMessage).where(
            ...
            GameMessage.message_id == game.lobby_message_id,
